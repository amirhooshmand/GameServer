...
namespace SmartClient
{
    class ClientTCP
    {
        ...
        private static void OnRecevie()
        {
            ...
            {
                Console.WriteLine("You are not connect t o server.");
            }
        }
        ...
        public static void SendGameobject()
        {
            ...
            buffer.WriteString("{ \"roomId\": 0, \"gameObject\": { \"id\": \"46546\", \"name\": \"N\", \"positionX\": 12.2, \"positionY\": 12.2, \"positionZ\":12, \"rotationX\": 12.2, \"rotationY\": 12.2, \"rotationZ\": 12.2 } }");
            SendData(buffer.ToArray());
            buffer.Dispose();
        }
